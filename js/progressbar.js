class ProgressBar {
  ...
  applyFillColor(fill) {
    const animations = {
      ...
      neon: 'neonAnimation 6s infinite alternate',
    ...
    if (animations[this.fillColor]) {
      ...
      this.injectKeyframes(`
        ...
        @keyframes neonAnimation {
            0% { background: radial-gradient(circle, rgba(0, 255, 255, 0.8) 20%, rgba(0, 255, 255, 0) 80%); filter: brightness(1) drop-shadow(0px 0px 10px #00ffff); }
            50% { background: radial-gradient(circle, rgba(0, 255, 255, 1) 20%, rgba(0, 255, 255, 0) 80%); filter: brightness(1.5) drop-shadow(0px 0px 20px #00ffff); }
            100% { background: radial-gradient(circle, rgba(0, 255, 255, 0.8) 20%, rgba(0, 255, 255, 0) 80%); filter: brightness(1) drop-shadow(0px 0px 10px #00ffff); }
          }
        @keyframes fade {
